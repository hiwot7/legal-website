...
export const T: Record<Lang, Translation> = {
  en: {
    ...
    areas: [
      { t: "Commercial Arbitration", d: "Representing clients in domestic and international arbitration proceedings for commercial disputes." },
      { t: "Court Proceedings", d: "Federal and regional court representation, from first filing through appeal." },
      { t: "Commercial Matters", d: "Contracts, corporate structuring, and commercial disputes for growing enterprises." },
      { t: "Trademark Registration", d: "Trademark search, filing, and registration to protect your brand in Ethiopia." },
      { t: "Taxation & Investment", d: "Tax planning, compliance, and investment structuring for local and foreign investors." },
      { t: "Employment & Immigration", d: "Employment contracts, work permits, immigration matters, and intellectual property protection." },
    ],
  ...
  am: {
    ...
    discuss: "ጉዳይዎን ያማክሩ",
    areas: [
      { t: "የንግድ ግልግል (አርቢትሬሽን)", d: "በአገር ውስጥ እና በዓለም አቀፍ የግልግል ሂደቶች ውስጥ የንግድ ክርክሮችን ውክልና።" },
      { t: "ክርክር (ፍርድ ቤት)", d: "ከፌደራል እና ክልል ፍርድ ቤቶች ውክልና፣ ከክስ አቀራረብ እስከ አቤቱታ።" },
      { t: "የንግድ ጉዳዮች", d: "ለሚያድጉ ድርጅቶች ውሎች፣ አደረጃጀት እና የንግድ ክርክሮች።" },
      { t: "የንግድ ምልክት ምዝገባ", d: "የንግድ ምልክት ፍለጋ፣ ማመልከቻ እና ምዝገባ ብራንድዎን ለመጠበቅ።" },
      { t: "ግብርና ኢንቨስትመንት", d: "ለሀገር ውስጥና የውጭ ባለሀብቶች የግብር ዕቅድ፣ ተገዢነት እና የኢንቨስትመንት አደረጃጀት።" },
      { t: "ስራና ስደት", d: "የስራ ውሎች፣ የስራ ፈቃድ፣ የስደት ጉዳዮች እና የአዕምሯዊ ንብረት ጥበቃ።" },
    ],
    teamEyebrow: "ቡድናችን",
  ...
  om: {
    ...
    areas: [
      { t: "Araarsummaa Daldalaa", d: "Bakka bu'iinsa maamiltoota falmii daldalaa keessatti, gara biyya keessaa fi idil-addunyaatti." },
      { t: "Falmii Mana Murtii", d: "Bakka bu'iinsa mana murtii federaalaa fi naannoo, iyyata irraa hanga apiilii." },
      { t: "Dhimmoota Daldalaa", d: "Waliigaltee, ijaarsa dhaabbataa, fi wal falmii daldalaa dhaabbilee guddataniif." },
      { t: "Galmeessa Mallattoo Daldalaa", d: "Barbaacha, iyyata, fi galmeessa mallattoo daldalaa maqaa keessan eeguuf." },
      { t: "Gibiraa fi Invastimantii", d: "Karoora gibiraa, hordoffii seeraa, fi ijaarsa invastimantii warra biyya keessaa fi alaatiif." },
      { t: "Hojii fi Godaansa", d: "Waliigaltee hojii, hayyama hojii, dhimmoota godaansaa, fi eegumsa qabeenya sammuu." },
